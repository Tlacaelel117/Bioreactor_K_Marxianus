...
# O₂
line_o2, = ax3.plot([], [], 'g.-', linewidth=1.5)
    ...
    while True:
        ...
        if current_time - last_avg_time >= avg_interval:
            if buffer_temp:
                ...
                avg_o2   = sum(buffer_o2)   / len(buffer_o2)
                ...
                line_o2.set_data(timeData_avg, o2Data_avg)
